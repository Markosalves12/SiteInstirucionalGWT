...
public class GreetingService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    var result = {};
    result["com.empresa.site.GreetingResponse/4221405304"] = [
        @com.empresa.site.GreetingResponse_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.empresa.site.GreetingResponse_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/empresa/site/GreetingResponse;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    var result = [];
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.empresa.site.GreetingResponse::class)] = "com.empresa.site.GreetingResponse/4221405304";
